...
```bash
curl -L https://raw.githubusercontent.com/aps831/terraform-bucket/v4.1.0/aws-init.sh | bash -s -- --prefix ${prefix} --project ${project} --profile ${profile} --region ${region} --tag ${tag}
```
...
```bash
curl -L https://raw.githubusercontent.com/aps831/terraform-bucket/v4.1.0/aws-cleanup.sh | bash -s -- --prefix ${prefix} --project ${project} --profile ${profile} --region ${region}
```
...
```bash
curl -L https://raw.githubusercontent.com/aps831/terraform-bucket/v4.1.0/gcp-init.sh | bash -s -- --account ${account} --gcpproject ${gcpproject} --region ${region}
```
...
```bash
curl -L https://raw.githubusercontent.com/aps831/terraform-bucket/v4.1.0/gcp-cleanup.sh | bash -s -- --gcpproject ${gcpproject}
```
